...
switch CATEGORY
    ...
    case 4 % neutral
        ...
        ind=find(x>=300 & x<1000);
        a(ind)=32.093;b(ind)=0.81066;
        
        ind=find(x>=1000 & x<3000);
        a(ind)=32.093;b(ind)=0.64403;
        
        ind=find(x>=3000 & x<10000);
        a(ind)=33.504;b(ind)=0.60486;
        
        ind=find(x>=10000 & x<30000);
...
theta=0.017453293.*(c-d.*log(abs(x+1e-15)./1000));
